...
const picks = [
  {
    ...
    "confidence": 71,
    "type": "Moneyline",
    "analysis": "Shesterkin elite at home this stretch (.934 SV%). Bruins on back-to-back. Take the value on the better goalie at plus money."
  },
  {
    "matchup": "Avalanche vs Stars",
    "time": "8:00 PM ET",
    "pick": "Over 6.5",
    "odds": "-118",
    "confidence": 68,
    "type": "Total",
    "analysis": "Both teams rank top-5 in goals for. Stars goalie coming off a rough start. Avalanche offense firing on all cylinders. Back the over."
  },
  {
    "matchup": "Oilers vs Flames",
    "time": "9:30 PM ET",
    "pick": "Oilers -1.5",
    "odds": "+168",
    "confidence": 63,
    "type": "Puck Line",
    "analysis": "McDavid vs Flames is a career mismatch. Edmonton won 4 straight by 2+ against Calgary. Long shot puck line worth a small play."
  }
]
...
export default function PicksPage() {
  return (
    <>
      <Head>
        <title>NHL Betting Picks & Predictions — PickWise AI</title>
        <meta name="description" content="Daily NHL puck line picks, moneylines, totals, and goalie-matchup analysis." />
      ...
      <div style={{ minHeight: '100vh', background: C.bg, fontFamily: "'Barlow', sans-serif", color: C.text }}>
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto', padding: '40px 24px 80px' }}>
          <div style={{ marginBottom: '32px' }}>
            <div style={{ fontSize: '11px', color: '#00509e', fontWeight: '800', letterSpacing: '0.1em', marginBottom: '10px' }}>AI PICKS</div>
            <h1 style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 'clamp(32px,5vw,56px)', fontWeight: '900', letterSpacing: '-0.02em', textTransform: 'uppercase', marginBottom: '12px' }}>🏒 NHL Betting Picks & Predictions</h1>
            <p style={{ fontSize: '15px', color: C.muted, lineHeight: 1.6, marginBottom: '20px' }}>Daily NHL puck line picks, moneylines, totals, and goalie-matchup analysis.</p>
            <div style={{ display: 'inline-flex', gap: '0', background: C.surface, border: `1px solid ${C.border}`, borderRadius: '8px', overflow: 'hidden' }}>
              {[['Season Record', '254-143 ML', C.text], ['ROI', '+12.9%', C.green]].map(([l, v, c]) => (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '14px', marginBottom: '40px' }}>
            {picks.map((p, i) => (
              <div key={i} style={{ background: C.surface, border: `1px solid ${C.border}`, borderRadius: '12px', padding: '22px', borderLeft: `4px solid #00509e` }}>
