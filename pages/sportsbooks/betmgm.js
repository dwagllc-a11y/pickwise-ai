...
export default function BookReview() {
  return (
    <>
      <Head>
        <title>BetMGM Sportsbook Review 2025 — PickWise AI</title>
        <meta name="description" content="BetMGM review: odds quality, first bet bonus, app, and our verdict for 2025." />
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "name": "BetMGM Sportsbook Review 2025", "reviewBody": "BetMGM offers the sharpest odds of any major sportsbook — a must-have for bettors who line shop. The $1,500 first bet offer is also among the most generous available.",
          "reviewRating": { "@type": "Rating", "ratingValue": 4.7, "bestRating": 5 },
          "itemReviewed": { "@type": "Product", "name": "BetMGM Sportsbook" }
        })}} />
      </Head>
      <div style={{ minHeight: '100vh', background: C.bg, fontFamily: "'Barlow', sans-serif", color: C.text }}>
        ...
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '48px 24px 80px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '20px' }}>
            ...
            <div>
              <h1 style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 'clamp(28px,4vw,48px)', fontWeight: '900', textTransform: 'uppercase', letterSpacing: '-0.02em' }}>BetMGM Sportsbook Review 2025</h1>
              <div style={{ display: 'flex', gap: '2px', alignItems: 'center', marginTop: '4px' }}>
                ...
                <span style={{ fontWeight: '800', marginLeft: '6px', color: '#c9a84c', fontSize: '18px' }}>4.7/5</span>
              </div>
            </div>
          </div>
          <div style={{ background: `rgba(255,255,255,0.04)`, border: `1px solid #c9a84c44`, borderRadius: '12px', padding: '20px', marginBottom: '28px' }}>
            <div style={{ fontSize: '13px', color: C.muted, marginBottom: '6px' }}>WELCOME BONUS</div>
            <div style={{ fontSize: '20px', fontWeight: '800', color: '#c9a84c', marginBottom: '12px' }}>First Bet up to $1,500</div>
            <a href="https://betmgm.com" target="_blank" rel="noopener noreferrer sponsored" style={{ display: 'inline-block', background: '#c9a84c', color: '#000', padding: '11px 24px', borderRadius: '7px', fontWeight: '800', fontSize: '14px' }}>Claim at BetMGM →</a>
          </div>
          <p style={{ fontSize: '16px', lineHeight: '1.8', color: '#9098a8', marginBottom: '28px' }}>BetMGM offers the sharpest odds of any major sportsbook — a must-have for bettors who line shop. The $1,500 first bet offer is also among the most generous available.</p>
